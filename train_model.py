...
from  get_model import get_text_model, get_image_model,get_credit_model
from data_pre import load_data, get_imb_data
os.environ["CUDA_VISIBLE_DEVICES"] = "0"

parser = argparse.ArgumentParser()
parser.add_argument('--data',choices=['mnist', 'cifar10','famnist','imdb','credit'], default='credit')
parser.add_argument('--model', choices=['image', 'text','credit'], default='credit')
parser.add_argument('--imb-rate',type=float, default=0.02)
parser.add_argument('--min-class', type=str, default='0')
parser.add_argument('--maj-class', type=str, default='1')
...
class ClassifyProcessor(Processor):
    ...
    def process_state_batch(self, batch):
        if args.model == 'text':
            ...
            return batch.reshape((-1 ,INPUT_SHAPE[0]))
